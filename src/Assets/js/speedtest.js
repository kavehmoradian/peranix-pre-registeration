 ...
 */
    ...
    Speedtest.prototype = {
        ...
        selectServer: function (result) {
            ...
            if (this._selectServerCalled) throw new Error("selectServer already called"); else this._selectServerCalled = true;
        ...
        start: function () {
            ...
            this.worker = new Worker(window.location.origin + "/speedtest_worker.js?r=" + Math.random());
